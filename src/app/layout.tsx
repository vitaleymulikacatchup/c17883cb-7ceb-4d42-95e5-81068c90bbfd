...
export const metadata: Metadata = {
  ...
  description: "Discover expertly crafted specialty coffee drinks at Brew Haven. Premium beans, skilled baristas, and warm hospitality in a modern coffee shop.",
  keywords: "specialty coffee, espresso, cappuccino, coffee shop, premium coffee, barista, cold brew",
  ...
  openGraph: {
    title: "Brew Haven - Premium Specialty Coffee Shop",
    description: "Discover expertly crafted specialty coffee drinks at Brew Haven.",
    url: "https://brewhaven.coffee",
    siteName: "Brew Haven",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763634838357-o6c561jh.jpg",
        alt: "Premium coffee at Brew Haven"
      }
    ]
  },
  twitter: {
    ...
    description: "Discover expertly crafted specialty coffee drinks.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763634838357-o6c561jh.jpg"]
  },
  robots: {
    index: true,
    follow: true
